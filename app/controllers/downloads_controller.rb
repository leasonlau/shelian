class DownloadsController < ApplicationController
  ...
  def show_kind
    @downloar_kinds =  Download.where(:kind => params[:kind]).page params[:page]
  end
  # GET /downloads/new
  ...
  def update
    ...
    respond_to do |format|
      Attachment.create(:attachment => params[:attachment], :attachmentable => @download) if params[:attachment]
