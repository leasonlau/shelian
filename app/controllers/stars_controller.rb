class StarsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @star.save
        format.html { redirect_to :back, notice: 'Star was successfully created.' }
  ...
  def update
    ...
    respond_to do |format|
      if @star.update_attributes(params[:star])
        Attachment.create(:attachment => params[:attachment], :attachmentable => @star) if params[:attachment]
        format.html { redirect_to :back, notice: 'Star was successfully updated.' }
